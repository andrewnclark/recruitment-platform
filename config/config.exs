...
config :recruitment, RecruitmentWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: RecruitmentWeb.ErrorHTML, json: RecruitmentWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Recruitment.PubSub,
  live_view: [signing_salt: "QXI02Bon"]
...
config :recruitment, Recruitment.Mailer, adapter: Swoosh.Adapters.Local
